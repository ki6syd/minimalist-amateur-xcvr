#define SWEEP_SETTLING_TIME 5
#define JSON_DOC_SIZE       8192
#define SELF_TEST_VOL       2
#define BPF_SWEEP_SPREAD    2000000
#define BPF_SWEEP_NUM_PTS   50
#define XTAL_SWEEP_SPREAD   5000
#define XTAL_SWEEP_NUM_PTS  100
#define AUDIO_SWEEP_SPREAD  4000
#define AUDIO_SWEEP_NUM_PTS 50
...
String bpf_sweep() {
  ...
  uint16_t step_size = BPF_SWEEP_SPREAD / BPF_SWEEP_NUM_PTS;
  uint16_t i = 0;
